...
// Управление яркостью подсветки экрана (Опционально)
//#define LCD_BRIGHT_PIN 5
// Управление яркостью подсветки приборной панели (Опционально)
...
// Это только для дисплея OLED с чипом SH1106 (stasoks)

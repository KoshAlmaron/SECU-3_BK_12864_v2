...
/*
	...
	5 - TM1637 DIO (ШИМ управление подсветкой дисплей (опционально))
	6 - TM1637 CLK
	7 - Вход для проверки состояния замка зажигания
	8 - Вход для проверки состояния габаритов
	9 - SPI DC
	10 - SPI CS
	11 - SPI MOSI
	...
	A4 - I2C SDA
	A5 - I2C SCL
	A6 - Фоторезистор регулировки яркости (Только вход АЦП для Nano)
	A7 - 								  (Только вход АЦП для Nano)
...
// Кнопки
#define BUTTON_UP_PIN A3		// Вверх
#define BUTTON_DOWN_PIN A1		// Вниз
#define BUTTON_LEFT_PIN A2		// Влево
#define BUTTON_RIGHT_PIN A0		// Вправо

// Входы для проверки состояний
#define INT_IGN_PIN 7			// Замка зажигания
#define INT_LIGHT_PIN 8			// Габаритов
...
#define FUEL_CONSUMPTION_RATIO 1.05
